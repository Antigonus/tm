...
(defun test-cell-list-2 ()
  (let*(
    ...
    (∧
      ...
      (= (esnr c0 2 {:➜ok (λ(v)v) :➜rightmost (be 17)}) 20)
      (= (esnr c0 3 {:➜ok (λ(v)v) :➜rightmost (be 17)}) 17)
      )))
  ...
  (let(
    ...
    (setf flag5
      (∧
        ...
        (= (esnr c2 1) 3)
        (= (esnr c2 2) 0)
        (= (esnr c2 3 {:➜ok #'cant-happen :➜rightmost (be 71)}) 71)
        ))
