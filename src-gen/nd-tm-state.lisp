...
;;
  ...
  (defmethod park-0 ((tm nd-tape-machine) (state void) cont-ok cont-void)
    (declare (ignore tm state cont-ok))
    (funcall cont-void)
    )
  (defmethod park-0 ((tm nd-tape-machine) (state parked) cont-ok cont-void)
    (declare (ignore tm state cont-void))
    (funcall cont-ok)
    )
  ;; this will work for many tm types
  (defmethod park-0 ((tm nd-tape-machine) (state active) cont-ok cont-void)
